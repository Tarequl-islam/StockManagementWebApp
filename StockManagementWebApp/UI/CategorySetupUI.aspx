...
<header> 
    ...
    <div align="center">
        ...
        <tr>
            ...
            <br />
            <br />
            <asp:GridView ID="categoryListGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText=" Action">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" OnClick="LinkButton_Click" runat="server">Update</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
